...
const surveyData = {
    ...
    questions: [
{
    text: "What is your favorite mobile network operator in South Africa?",
    options: [
        { text: "Vodacom", emoji: "📱" },
        { text: "MTN", emoji: "📲" },
        { text: "Cell C", emoji: "☎️" }
...
},
{
    ...
    options: [
        { text: "Bank EFT", emoji: "🏦" },
        { text: "Debit/Credit Card", emoji: "💳" },
        { text: "Cash", emoji: "💵" }
    ],
    reward: 33
},
{
    text: "How would you rate banking services in South Africa?",
    options: [
        { text: "Excellent", emoji: "🌟" },
        { text: "Fair", emoji: "⭐" },
        { text: "Needs improvement", emoji: "⚠️" }
    ],
    reward: 48
},
{
    text: "Which of these brands do you trust the most?",
    options: [
        { text: "Local South African brands", emoji: "🇿🇦" },
        { text: "Famous international brands", emoji: "🌍" },
        { text: "Depends on the product", emoji: "🤔" }
    ],
    reward: 53
}
